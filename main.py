...
# pokemon_data = response.json() #converts from Javascript Object Notation into Python lists and dictionionaries
#
# print(pokemon_data['name'])



#random pokemon query
import requests
import random

pokemon_ids = random.sample(range(1, 152), 6)

with open('pokemon encyclopedia.txt', 'w') as pokemon_file:
